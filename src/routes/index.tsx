...
function Landing({ openAuth, openDemo, authOpen, closeAuth, refresh }: { openAuth: () => void; openDemo: () => void; authOpen: boolean; closeAuth: () => void; refresh: () => Promise<void> }) {
  ...
  return <div className="landing">
    ...
    <footer><Brand/><p>Health tracking for information and organization — not diagnosis or treatment.</p><span>© 2026 Vitality</span></footer>
...
function Brand() { return <a className="brand" href="#top"><div className="brand-mark"><HeartPulse /></div><div><strong>VITAL</strong><span>ITY</span></div></a> }
...
function LoadingScreen({ message = 'Loading Vitality…' }: { message?: string }) { return <div className="loading-screen"><div className="loading-mark"><HeartPulse/><i/></div><strong>VITALITY</strong><span>{message}</span></div> }
